...
namespace MAUI_RatingView.Material;
public static class MaterialIconTwoTone
{
    ...
    public const string Signal_cellular_connected_no_internet_1_bar = "\uf0ad";
    public const string Signal_cellular_connected_no_internet_2_bar = "\uf0ae";
    public const string Signal_cellular_connected_no_internet_3_bar = "\uf0af";
    ...
    public const string Signal_wifi_1_bar = "\uf0b1";
    public const string Signal_wifi_1_bar_lock = "\uf0b2";
    public const string Signal_wifi_2_bar = "\uf0b3";
    public const string Signal_wifi_2_bar_lock = "\uf0b4";
    public const string Signal_wifi_3_bar = "\uf0b5";
    public const string Signal_wifi_3_bar_lock = "\uf0b6";
    public const string Signal_wifi_4_bar = "\ue1d8";
    public const string Signal_wifi_4_bar_lock = "\ue1d9";
    public const string Signal_wifi_bad = "\uf063";
    public const string Signal_wifi_connected_no_internet_0 = "\uf0f2";
    public const string Signal_wifi_connected_no_internet_1 = "\uf0ee";
    public const string Signal_wifi_connected_no_internet_2 = "\uf0f1";
    public const string Signal_wifi_connected_no_internet_3 = "\uf0ed";
    public const string Signal_wifi_connected_no_internet_4 = "\uf064";
    public const string Signal_wifi_off = "\ue1da";
    public const string Signal_wifi_statusbar_1_bar = "\uf0e6";
    public const string Signal_wifi_statusbar_2_bar = "\uf0f0";
    public const string Signal_wifi_statusbar_3_bar = "\uf0ea";
    public const string Signal_wifi_statusbar_4_bar = "\uf065";
    public const string Signal_wifi_statusbar_connected_no_internet = "\uf0f8";
    public const string Signal_wifi_statusbar_connected_no_internet_1 = "\uf0e9";
    public const string Signal_wifi_statusbar_connected_no_internet_2 = "\uf0f7";
    public const string Signal_wifi_statusbar_connected_no_internet_3 = "\uf0e8";
